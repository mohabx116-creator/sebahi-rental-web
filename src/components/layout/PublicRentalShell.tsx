        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link className="flex items-center gap-3" to={ROUTES.RENTALS}>
            ...
            <div className="text-right">
              <p className="text-sm font-black text-fixed sm:text-base">إيجارات كمباوند السبحي</p>
              <p className="hidden text-xs font-medium text-fixed-dim sm:block">سوق الإيجارات داخل كمباوند السبحي</p>
            </div>
          </Link>
      ...
      <footer className="border-t border-outline bg-surface-dim/40 text-fixed-dim">
        <div className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-10 text-right text-sm sm:px-6 lg:grid-cols-[1.2fr_1fr_1fr] lg:items-start lg:px-8">
          <div className="space-y-3">
            ...
            <p className="mt-1 leading-7 text-fixed-dim/90">منصة عرض وحدات الإيجار داخل كمباوند السبحي مع تحقق دفع آمن عبر الخادم.</p>
